...
import controller.TeacherModify;
 ...
 * @author Quoc
 */
public class SearchTeachers extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "DOB", "Address", "Gender", "Phone Number", "Mail", "Faculty ID"
            }
        ));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Teacher detail"));
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(tfDOB, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(cbFacultyID, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(46, 46, 46))))
        );
    ...
    private void showTeacher() {
        ...
        teacherList.forEach((teacher) -> {
            tableModel.addRow(new Object[] {teacher.getId(), teacher.getName(),teacher.getDob(),teacher.getAddress(),teacher.getGender(), teacher.getPhone(),teacher.getMail()
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        Teacher t = new Teacher(id, sname, gender, address, dob, mail, phone, facultyid);
        TeacherModify.update(t);         
        showTeacher();
        } catch (Exception e) {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        Teacher t = new Teacher(id, sname, null, null, null, null, ABORT, ABORT);
        teacherList = TeacherModify.search(t);
        ...
        teacherList.forEach((teacher) -> {
            ...
            JOptionPane.showMessageDialog(this, "Please fill in ID Teacher");
        }
    ...
    private void tbMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMousePressed
        ...
        cbFacultyID.setSelectedItem(tableModel.getValueAt(i, 7).toString());
